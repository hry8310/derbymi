...
public interface LanguageConnectionContext extends Context {
	...
	*/
     ...
     * {@link org.apache.dearbaby.impl.sql.compile.StaticMethodCallNode#generatePushNestedSessionContext}.
	 * <p>
	 * The new SQL session context is also set in the current statement
	 * context (of the invocation).
	 *
     * @see org.apache.dearbaby.impl.sql.compile.StaticMethodCallNode#generatePushNestedSessionContext
	 ...
	 * @see org.apache.dearbaby.impl.sql.compile.QueryTreeNode#treePrint(int)
	 * @return the map
	 */
