    ...
    extends DataType implements StringDataValue, StreamStorable
{
    ...
    */
        ...
        throws StandardException
    {
        ...
        SQLDate internalDate = new SQLDate(str, false );
        ...
        throws StandardException
    {
        if( str == null)
            return null;
        SQLTime internalTime = new SQLTime( str, false,   cal);
    ...
    {
        return getTimestamp( cal, getString());
    }
        ...
        throws StandardException
    {
        ...
        SQLTimestamp internalTimestamp = 
            new SQLTimestamp( str, false,   cal);
