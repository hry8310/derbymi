						...
						implements DateTimeDataValue
{
	...
	*/
     ...
     * out of range
     */
    public SQLTime( String timeStr, boolean isJdbcEscape )
        throws StandardException
    {
        parseTime( timeStr, isJdbcEscape,  (Calendar) null);
    }
     ...
     * out of range
     */
    public SQLTime( String timeStr, boolean isJdbcEscape,   Calendar cal)
        throws StandardException
    {
        parseTime( timeStr, isJdbcEscape,   cal);
    }
    ...
    private void parseTime( String timeStr, boolean isJdbcEscape,  Calendar cal)
        throws StandardException
    {
