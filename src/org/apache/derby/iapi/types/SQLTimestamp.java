						...
						implements DateTimeDataValue
{
	...
	*/
    ...
    private static final int BASE_MEMORY_USAGE = 0;
	...
	*/
     ...
     */
    public SQLTimestamp( String timestampStr, boolean isJDBCEscape )
        throws StandardException
    {
        parseTimestamp( timestampStr, isJDBCEscape,  (Calendar) null);
    }
     ...
     * and hour part of the timestamp. The microsecond part may be omitted or truncated.
     */
    public SQLTimestamp( String timestampStr, boolean isJDBCEscape,  Calendar cal)
        throws StandardException
    {
        parseTimestamp( timestampStr, isJDBCEscape, cal);
    }
    ...
    private void parseTimestamp( String timestampStr, boolean isJDBCEscape,  Calendar cal)
        throws StandardException
    {
     ...
     */
    static int[] parseLocalTimestamp( String str,   Calendar cal)
