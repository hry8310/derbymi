 ...
 */
public final class DataValueFactoryImpl implements DataValueFactory 
{
    ...
    {
        return new SQLDate( dateStr, isJdbcEscape );
    ...
    {
        return new SQLTime( timeStr, isJdbcEscape );
    ...
    {
        return new SQLTimestamp( timestampStr, isJdbcEscape );
