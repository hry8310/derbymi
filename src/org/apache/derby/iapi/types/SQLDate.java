						...
						implements DateTimeDataValue
{
	...
	*/
     ...
     * out of range
     */
    public SQLDate( String dateStr, boolean isJdbcEscape )
        throws StandardException
    {
        parseDate( dateStr, isJdbcEscape,   (Calendar) null);
    }
     ...
     * out of range
     */
    public SQLDate( String dateStr, boolean isJdbcEscape,  Calendar cal)
        throws StandardException
    {
        parseDate( dateStr, isJdbcEscape,   cal);
    }
    ...
    private void parseDate( String dateStr, boolean isJdbcEscape, Calendar cal)
        throws StandardException
    {
