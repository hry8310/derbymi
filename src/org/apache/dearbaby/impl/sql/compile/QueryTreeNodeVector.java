...
/**
 * QueryTreeNodeVector is the root class for all lists of query tree nodes. It
 * provides a wrapper for java.util.ArrayList. All lists of query tree nodes
 * inherit from QueryTreeNodeVector.
 *
 */

class QueryTreeNodeVector<E extends QueryTreeNode> extends QueryTreeNode
		implements Iterable<E> {
	public final ArrayList<E> v = new ArrayList<E>();
